...
router.post("/webhook", async (req, res) => {
  ...
  try {
    ...
    if (action === "wd_approve") {
      ...
      // Ambiguous-timeout case: admin has checked SmartPay's dashboard
      // directly and confirmed the wallet was actually debited for this
      // payout, so it's safe to mark it completed without ever having
      // gone through "approved" first.
